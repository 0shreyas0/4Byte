...
const DEFAULT_REGISTRY_URL = "https://raw.githubusercontent.com/Pruthv-creates/website-template/main/registry/modules.json";

export async function loadRegistry(registryUrl?: string): Promise<RemoteModule[]> {
